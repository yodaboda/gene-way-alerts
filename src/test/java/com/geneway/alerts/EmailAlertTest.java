...
public class EmailAlertTest {
	...
	public void testRemindAddressException() throws AddressException, MessagingException {
		AlertMechanism mockedAlertMechanism = mock(EmailAlertMechanism.class);
		...
		assertEquals("MementoMessage{formattedMessage='javax.mail.internet.AddressException: wrong address', format='javax.mail.internet.AddressException: wrong address', parameters=[]}", logEvent.getMessage().toString());
	}
	...
	public void testRemindMessagingException() throws AddressException, MessagingException {
		...
		LogEvent logEvent = events.get(0);
		assertEquals(Level.FATAL, logEvent.getLevel());
		assertEquals("MementoMessage{formattedMessage='javax.mail.MessagingException: messaging exception', format='javax.mail.MessagingException: messaging exception', parameters=[]}", logEvent.getMessage().toString());
	}
}
